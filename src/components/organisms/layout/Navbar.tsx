...
const Navbar = () => {
  ...
  return (
    <div className="bg-blue-cs-40/85 fixed top-4 left-1/2 z-10 flex w-[calc(100%-3rem)] -translate-x-1/2 items-center justify-between rounded-[20px] px-12 py-4 text-white backdrop-blur-xs">
